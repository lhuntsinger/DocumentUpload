...
public class HandlingMails extends TestBase {
	...
	public enum EmailFolder {
	  ...
	  public HandlingMails(String username, String password, EmailFolder emailFolder) throws MessagingException {
		    Properties props = System.getProperties();
		    try {
		      props.load(new FileInputStream(new File("C:\\Workspace\\DocumentsUpload\\src\\main\\resources\\email.properties")));
		    } catch(Exception e) {
		      e.printStackTrace();
		      System.exit(-1);
		    }
