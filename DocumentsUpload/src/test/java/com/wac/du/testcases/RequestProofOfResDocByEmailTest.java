...
public class RequestProofOfResDocByEmailTest extends TestBase {
...
// Test Case: Request Proof of Residence Document by Email for Individual Borrower
// Scenario: User goes to Documents Upload URL, navigates to Loan Request page, enters Individual Borrower Application ID, 
// 			 verifies Notify via Email option is selected, selects Proof of Residence from Required Documents 
// 			 and selects Send Request button
// Expected Results: Email should be received with Upload Document link for Proof of Residence
	
	@Test
	public void requestPrfOfResDocByEmail(ITestContext ctx) {
	  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		
		String instance = "24715749";
		...
		LnRqstPge.clickRequest();
	  	...
	  	Boolean isDisplayed1 = LnRqstPge.checkReqDocResidence();
	  	softAssert.assertTrue(isDisplayed1);
	  	
	  	log.info("*************** End Verify Proof of Residence Doc is visible ***************");
	  	...
	  	// Select Proof of Residence document under Required Documents
