...
public class VerifyEmailFieldCannotBeEditedForSecondaryJBTest extends TestBase {
...
// Test Case: Verify that Email field cannot be edited for Secondary Joint Borrower
// Scenario: User goes to Documents Upload URL, enters Joint Borrower Application ID, verifies applicant email information,
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  log.info("*************** End Select Secondary Joint Borrower Name ***************");
 		  ...
 		  log.info("*************** Start Verify Secondary Joint Borrower Email ***************");
		  	
		  // Verify Loan Application Email
		  String lnEmail = LnRqstPge.checkEmail();
		  softAssert.assertEquals(lnEmail, "test3@worldacceptance.com");
		  	
		  log.info("*************** End Verify Secondary Joint Borrower Email ***************");
