...
public class VerifyEmailFieldCannotBeEditedForPrimaryJBTest extends TestBase {
...
// Test Case: Verify that Email field cannot be edited for Primary Joint Borrower
...
// Expected Results: Email field cannot be edited
	  ...
	  @Test
	  public void verifyEmailNotEditableForPrimaryJointBorrower(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24767044";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  log.info("*************** Start Verify Primary Joint Borrower Email ***************");
		  ...
		  log.info("*************** End Verify Primary Joint Borrower Email ***************");
