...
public class RequestIDDocByEmailTest extends TestBase {
...
// Test Case: Request ID Document by Email for Individual Borrower
...
// Expected Results: Email should be received with Upload Document link for ID
	
	@Test
	public void requestIdDocByEmail(ITestContext ctx) {
	  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		
		String instance = "23522671";
		...
		// Select the Loan ID link on History page
