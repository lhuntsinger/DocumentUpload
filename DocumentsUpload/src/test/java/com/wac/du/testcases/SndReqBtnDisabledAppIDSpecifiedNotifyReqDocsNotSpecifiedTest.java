...
public class SndReqBtnDisabledAppIDSpecifiedNotifyReqDocsNotSpecifiedTest extends TestBase {
...
// Test Case: Send Request button disabled when Application ID entered, Notification option and Required Documents not specified
// Scenario: User goes to Documents Upload URL, navigates to Loan Request page, enters Application ID, does not select 
// 			 Notification option or any Required Documents	
// Expected Results: Loan Request page displayed, Application ID entered and Send Request button is disabled
	
	  @Test
	  public void verifySndReqBtnDisabledAppIDSpecified(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24215315";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  // Click Notify via Email check box to de-select
