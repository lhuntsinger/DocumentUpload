...
public class RequestALLDocsByEmailTest extends TestBase {
...
// Test Case: Request ALL documents by Email for Individual Borrower
...
//			 selects ALL documents and selects Send Request button	
// Expected Results: Email for ALL requested documents is received and matches the request
	
	  @Test
	  public void verifyRequestAny4DocsByEmail(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24888162";
