...
public class VerifyPhoneFieldCannotBeEditedForIndividualBorrowerTest extends TestBase {
...
// Test Case: Verify that Phone field cannot be edited for Individual Borrower
// Scenario: User goes to Documents Upload URL, enters Individual Borrower Application ID, verifies applicant Phone information,
//			 verifies that Phone field cannot be edited
// Expected Results: Phone field cannot be edited

	
	  @Test
	  public void verifyPhoneNotEditableForIndividualBorrower(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24837593";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  // Verify Individual Borrower Phone
