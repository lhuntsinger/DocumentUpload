...
public class VerifyEmailFieldCannotBeEditedForIndividualBorrowerTest extends TestBase {
...
// Test Case: Verify that Email field cannot be edited for Individual Borrower
// Scenario: User goes to Documents Upload URL, enters Individual Borrower Application ID, verifies applicant email information,
//			 verifies that Email field cannot be edited
// Expected Results: Email field cannot be edited

	
	  @Test
	  public void verifyEmailNotEditableForIndividualBorrower(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24808580";
