...
public class RequestProofOfInsDocByEmailTest extends TestBase {
...
// Test Case: Request Proof of Insurance Document by Email for Individual Borrower
// Scenario: User goes to Documents Upload URL, navigates to Loan Request page, enters Individual Borrower Application ID, 
//  		 verifies Notify via Email option is selected, selects Proof of Insurance from Required Documents 
// 			 and selects Send Request button
// Expected Results: Email should be received with Upload Document link for Proof of Insurance
	
	@Test
	public void requestPrfOfInsDocByEmail(ITestContext ctx) {
	  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		
		String instance = "24719377";
		...
		LnRqstPge.clickRequest();
	  	...
	  	Boolean isDisplayed1 = LnRqstPge.checkReqDocInsurance();
