...
public class RequestAny2DocsByEmailTest extends TestBase {
...
// Test Case: Request any two documents by Email for Individual Borrower
...
//			 selects any two documents and selects Send Request button	
// Expected Results: Email for requested two documents is received and match the request
	
	  @Test
	  public void verifyRequestAny2DocsByEmail(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24886781";
