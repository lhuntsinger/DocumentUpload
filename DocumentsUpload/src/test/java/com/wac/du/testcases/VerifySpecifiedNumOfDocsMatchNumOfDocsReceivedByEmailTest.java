...
public class VerifySpecifiedNumOfDocsMatchNumOfDocsReceivedByEmailTest extends TestBase {
...
// Test Case: Request any number of documents by Email for Individual Borrower
...
//			 selects any number of documents and selects Send Request button	
// Expected Results: Email for requested number of documents is received and match the request
	
	  @Test
	  public void verifySpecifiedNumOfDocsRequestedMatchNumOfDocsReceivedByEmail(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24986162";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  log.info("********************* End of History Page Test ******************");
		  	...
		  	softAssert.assertEquals(lnExpDate, "May 19, 2020");
		  	...
		  	log.info("*************** Start Select Number of ID Documents ***************");
		  	
		  	LnRqstPge.selectNumOfIdDocs();
		  	
		  	log.info("*************** End Select Number of ID Documents ***************");
		  	...
		  	log.info("*************** Start Select Number of Proof of Income Documents ***************");
		  	
		  	LnRqstPge.selectNumOfPrfOfIncDocs();
		  	
		  	log.info("*************** End Select Number of Proof of Income Documents ***************");
