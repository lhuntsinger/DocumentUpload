...
public class VerifyBranchFieldCannotBeEditedForIndividualBorrowerTest extends TestBase {
...
// Test Case: Verify that Branch field cannot be edited for Individual Borrower
// Scenario: User goes to Documents Upload URL, enters Individual Borrower Application ID, verifies applicant Branch information,
//			 verifies that Branch field cannot be edited
// Expected Results: Branch field cannot be edited

	
	  @Test
	  public void verifyBranchNotEditableForIndividualBorrower(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24846451";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  // Verify Individual Borrower Branch
