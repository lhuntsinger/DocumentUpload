...
public class VerifyBranchFieldCannotBeEditedForPrimaryJBTest extends TestBase {
...
// Test Case: Verify that Branch field cannot be edited for Primary Joint Borrower
...
// Expected Results: Branch field cannot be edited
	  ...
	  @Test
	  public void verifyBranchNotEditableForPrimaryJointBorrower(ITestContext ctx) {
		  
		String dateAndTime = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
			
		String instance = "24846452";
		...
		SoftAssert softAssert = new SoftAssert();
		 ...
		 Boolean isActive =  HstryPge.verifyHistoryPageDisplayed();
		  ...
		  log.info("*************** Start Verify Primary Joint Borrower Branch ***************");
		  	
		  // Verify Primary Joint Borrower Branch
		  String lnBranch = LnRqstPge.checkBranch();
		  softAssert.assertEquals(lnBranch, "0377 - Mauldin");
		  	
		  log.info("*************** End Verify Primary Joint Borrower Branch ***************");
